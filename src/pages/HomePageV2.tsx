...
const ALL_NEW_STUFF = [
  { name: 'Spikes', thumb: 'https://ordinals.com/content/e7ddfba5037731094b38f9214667e6a44f041fe02de9397e48bb6506f40246a1i0', route: '/spikes', tag: 'NEW', tagColor: 'bg-red-600' },
  ...
  { name: 'Neuro Drift', thumb: '/images/neuro-drift.png', route: 'https://ord-dropz.xyz/games/listing_1777326819798', tag: 'OrdDropz', tagColor: 'bg-blue-600', external: true },
