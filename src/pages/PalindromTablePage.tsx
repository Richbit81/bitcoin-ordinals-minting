...
export const PalindromTablePage: React.FC = () => {
        ...
        <div className="text-center max-w-md">
          ...
          <p className="text-gray-400 mb-8">
            {walletState.connected
              ? 'Your wallet is not authorized to access PalindromTable.'
              : 'Please connect an authorized wallet to access PalindromTable.'}
          </p>
          <button
            onClick={() => navigate('/')}
  ...
  return (
    <div className="fixed inset-0 w-full h-full bg-black" style={{ zIndex: 50 }}>
      <iframe
        src="/palindrom-table/index.html"
        title="PalindromTable"
