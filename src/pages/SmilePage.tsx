...
export const SmilePage: React.FC = () => {
  ...
  const handleMint = async (item?: CollectionItem) => {
    ...
    if (walletState.walletType === 'unisat') {
      ...
      if (address) {
        userAddress = address;
        console.log('[SmilePage] ✅ UniSat - Verwende Adresse für Inscription:', userAddress);
      }
      ...
      if (ordinalsAccount) {
        ...
        console.log('[SmilePage] ✅ Xverse - Verwende Ordinals-Adresse für Inscription:', userAddress);
      } else {
        console.warn('[SmilePage] ⚠️ Xverse - Keine Ordinals-Adresse gefunden, verwende:', userAddress);
      }
      ...
      if (paymentAccount) {
        console.log('[SmilePage] 💰 Xverse - Payment kommt von:', paymentAccount.address);
      }
    }
