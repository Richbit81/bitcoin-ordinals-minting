...
export const VideoSplitterPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col">
      ...
      <div className="flex items-center gap-4 p-4 border-b border-gray-800">
        ...
        <h1 className="text-xl font-bold">Video Splitter Tool</h1>
      </div>

      {/* Iframe */}
      <iframe
        src="/tools/video_splitter_tool.html"
        className="flex-1 w-full border-0"
        title="Video Splitter Tool"
